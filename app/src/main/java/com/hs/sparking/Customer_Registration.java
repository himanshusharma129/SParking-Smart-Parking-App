...
public class Customer_Registration extends AppCompatActivity {
    ...
    private TextInputLayout name,mobile,email,pass;
    private Button sign;
    private String c_name,c_email,c_mobile,c_pass;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        sign.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if(c_mobile.isEmpty()||c_name.isEmpty()||c_pass.isEmpty()||c_email.isEmpty()){
